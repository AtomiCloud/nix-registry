...
Checks (there are exactly seven; there is no 'all'):
...
main() {
  ...
  *)
    usage_error "unknown check '${command}'; dlint has exactly seven: action-pins, exec-bits, ci-wiring, skills-fresh, toolchain-smoke, workflow-policy, no-custom-derivations"
    ;;
  esac
}
