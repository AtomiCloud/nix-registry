...
today — and there are arms running all five checks from a YAML config to hold that.
...
`tests/inject.sh` is the failure-injection harness: **111 arms**, each asserting the
