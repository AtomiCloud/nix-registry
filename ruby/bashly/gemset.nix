{
  bashly = {
    dependencies = [ "colsole" "completely" "filewatcher" "gtx" "logger" "lp" "mister_bin" "ostruct" "requires" "tty-markdown" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0mbppnrdhcp86v34mxk8xzi88nra5f2dy8vb3vsnjpqxwjq30j6r";
      type = "gem";
    };
    version = "1.2.7";
  };
